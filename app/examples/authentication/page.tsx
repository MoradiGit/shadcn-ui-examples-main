...
export default function AuthenticationPage() {
  return (
    <>
      ...
      <div dir="ltr" className="container relative  h-screen flex-col items-center justify-center grid lg:max-w-none lg:grid-cols-2 lg:px-0 " >
